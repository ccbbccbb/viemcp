...
export function formatBalance(balance: bigint, decimals: number = 18, symbol?: string): string {
  const formatted = decimals === 18 ? formatEther(balance) : formatUnits(balance, decimals);
